...
| `resident_status`       | `active`, `inactive`, `moved_out`, `deceased`                                                           |
...
| ------------------ | ------------------ | ------------------------ | -------------------------------------------- |
| `id`               | `uuid`             | Not null; generated UUID | PK                                           |
| `household_number` | `text`             | Not null                 | Globally unique uppercase display identifier |
| `barangay_id`      | `uuid`             | Not null                 | FK to `barangays.id`                         |
...
`household_number` matches `HH-[A-Z0-9][A-Z0-9-]{2,29}`. Unique
...
| `address_line`                   | `text`                  | Not null                    | Resident address; household relationship remains authoritative |
...
| `request_metadata` | `jsonb`       | Nullable                 | Reserved safe metadata object; automatic triggers leave null |
