-- Permit narrative-free cancellation for every already-authorized cancellation
-- path. A staff rejection of a pending Resident request remains a distinct,
-- accountable transition and still requires a bounded justification.
