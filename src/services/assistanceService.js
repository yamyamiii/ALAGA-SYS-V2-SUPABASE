    ...
    saveAnnouncement(values) {
      return rpc(
        ...
        "announcement_save",
        {
          ...
          p_publish_at: nullable(values.publish_at),
          p_event_start_at: nullable(values.event_start_at),
          p_event_end_at: nullable(values.event_end_at),
          p_expires_at: nullable(values.expires_at),
          p_is_pinned: Boolean(values.is_pinned),
          p_publish_now: Boolean(values.publish_now),
